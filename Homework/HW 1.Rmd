...
print("Values using the sum:")
exp_sum(10)
exp_sum(20)
exp_sum(30)
exp_sum(40)

print("Values using the quick formula:")
exp_quick(10)
exp_quick(20)
exp_quick(30)
exp_quick(40)
...
rho_n <- function(n)
{
  return(exp(lgamma((n-1)/2))/(exp(lgamma(1/2))*exp(lgamma((n-2)/2))))
}
```
...
#rho_n(n)/sqrt(n) tends to ~0.3973811
```
