...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{curve}\hlstd{(}\hlkwd{sin}\hlstd{(}\hlnum{10}\hlopt{*}\hlstd{x)}\hlopt{-}\hlstd{x,} \hlkwc{ylab}\hlstd{=}\hlstr{"y"}\hlstd{,} \hlkwc{from}\hlstd{=}\hlopt{-}\hlnum{1.5}\hlstd{,} \hlkwc{to}\hlstd{=}\hlnum{1.5}\hlstd{)}
\hlkwd{abline}\hlstd{(}\hlkwc{add}\hlstd{=}\hlnum{TRUE}\hlstd{,} \hlkwc{h}\hlstd{=}\hlnum{0}\hlstd{)}
\end{alltt}
...
\hlstd{f}\hlkwb{=}\hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{)} \hlkwd{abs}\hlstd{(}\hlkwd{sin}\hlstd{(}\hlnum{10}\hlopt{*}\hlstd{x)}\hlopt{-}\hlstd{x)}
\hlstd{root}\hlkwb{=}\hlkwd{numeric}\hlstd{(}\hlnum{7}\hlstd{)}
\hlstd{root[}\hlnum{1}\hlstd{]}\hlkwb{=}\hlkwd{optim}\hlstd{(}\hlopt{-}\hlnum{.85}\hlstd{, f)}\hlopt{$}\hlstd{par}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in optim(-0.85, f): one-dimensional optimization by Nelder-Mead is unreliable:\\\#\# use "{}Brent"{} or optimize() directly}}\begin{alltt}
\hlstd{root[}\hlnum{2}\hlstd{]}\hlkwb{=}\hlkwd{optim}\hlstd{(}\hlopt{-}\hlnum{.7}\hlstd{, f)}\hlopt{$}\hlstd{par}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in optim(-0.7, f): one-dimensional optimization by Nelder-Mead is unreliable:\\\#\# use "{}Brent"{} or optimize() directly}}\begin{alltt}
\hlstd{root[}\hlnum{3}\hlstd{]}\hlkwb{=}\hlkwd{optim}\hlstd{(}\hlopt{-}\hlnum{.3}\hlstd{, f)}\hlopt{$}\hlstd{par}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in optim(-0.3, f): one-dimensional optimization by Nelder-Mead is unreliable:\\\#\# use "{}Brent"{} or optimize() directly}}\begin{alltt}
\hlstd{root[}\hlnum{4}\hlstd{]}\hlkwb{=}\hlkwd{optim}\hlstd{(}\hlnum{0}\hlstd{, f)}\hlopt{$}\hlstd{par}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in optim(0, f): one-dimensional optimization by Nelder-Mead is unreliable:\\\#\# use "{}Brent"{} or optimize() directly}}\begin{alltt}
\hlstd{root[}\hlnum{5}\hlstd{]}\hlkwb{=}\hlkwd{optim}\hlstd{(}\hlnum{.3}\hlstd{, f)}\hlopt{$}\hlstd{par}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in optim(0.3, f): one-dimensional optimization by Nelder-Mead is unreliable:\\\#\# use "{}Brent"{} or optimize() directly}}\begin{alltt}
\hlstd{root[}\hlnum{6}\hlstd{]}\hlkwb{=}\hlkwd{optim}\hlstd{(}\hlnum{.7}\hlstd{, f)}\hlopt{$}\hlstd{par}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in optim(0.7, f): one-dimensional optimization by Nelder-Mead is unreliable:\\\#\# use "{}Brent"{} or optimize() directly}}\begin{alltt}
\hlstd{root[}\hlnum{7}\hlstd{]}\hlkwb{=}\hlkwd{optim}\hlstd{(}\hlnum{.85}\hlstd{, f)}\hlopt{$}\hlstd{par}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in optim(0.85, f): one-dimensional optimization by Nelder-Mead is unreliable:\\\#\# use "{}Brent"{} or optimize() directly}}\begin{alltt}
\hlkwd{cat}\hlstd{(}\hlstr{"The function has 7 zeroes, the roots are: \textbackslash{}n"}\hlstd{, root,} \hlstr{"\textbackslash{}n"}\hlstd{)}
\end{alltt}
\begin{verbatim}
